...
export function clockCursor(options) {
    ...
    const dateColor = (options && options.dateColor) || "Indigo";
    ...
    const fontSize = (options && options.fontSize) || "15px";
    const followDelay = (options && options.followDelay) || 0.5;
    const totalSize = (options && options.totalSize) || 50;

    const del = followDelay; //跟随延迟
