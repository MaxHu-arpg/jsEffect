// fun options!
const PARTICLES_PER_FIREWORK = 1000; // 100 - 400 or try 1000
const FIREWORK_CHANCE = 0; // percentage, set to 0 and click instead(自动放烟花选项，0时只有按才放烟花)
const BASE_PARTICLE_SPEED = 4; // between 0-4, controls the size of the overall fireworks
const FIREWORK_LIFESPAN = 600; // ms
const PARTICLE_INITIAL_SPEED = 8; // 2-8
...
canvas.setAttribute("style", "width: 100%; height: 100%; top: 0; left: 0; z-index: 9999999999; position: fixed; pointer-events: none;");
